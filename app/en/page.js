...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
const HERO = {
  eyebrow: "Overseas Crowdfunding × Global Expansion Support",
  body: "We validate market demand on Kickstarter, Indiegogo, and zeczec, then support you end-to-end — from cross-border e-commerce and Faire wholesale to overseas distributor development.",
  cta: "Book a Free Consultation",
  images: ["/images/top1.jpg", "/images/top2.jpg"],
};

// JP版レイアウトのhtml lang="ja"はルートレイアウトで固定のため、
// 英語版ページ滞在中のみクライアント側でlangを一時的に上書きする
  ...
  return (
    <>
      ...
      >
        ...
        <motion.div
          style={{ y: textY }}
          className="relative z-10 min-h-screen flex flex-col justify-center px-8 md:px-20 max-w-[760px] lg:max-w-[840px] pt-16"
        >
          {/* 細い水平ライン + ラベル */}
          <motion.div
          ...
          <div className="mb-12">
            <h1
              className="text-white font-black leading-[0.98]"
          ...
          >
            ...
            <motion.button
              ...
              whileHover={{ x: 4 }}
            >
              See Our Track Record <span>→</span>
            </motion.button>
          </motion.div>
        ...
        {/* Hero→Projectsのグラデーションブリッジ（背景色の急変を緩和） */}
        <div className="absolute bottom-0 left-0 right-0 h-16 md:h-20 bg-gradient-to-b from-transparent to-[#111827]" />
      </div>
          ...
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-10">
            ...
            <nav className="grid grid-cols-2 gap-x-16 gap-y-3 text-white/50 text-sm">
              ...
              <Link href="/blog" className="hover:text-white transition-colors">
                Blog <span className="text-white/25 text-[10px] font-normal tracking-wide">(JP)</span>
              </Link>
              <a href="#contact" className="hover:text-white transition-colors">Contact</a>
              <Link href="/privacy" className="hover:text-white transition-colors">
                Privacy Policy <span className="text-white/25 text-[10px] font-normal tracking-wide">(JP)</span>
              </Link>
              <Link href="/dx" className="hover:text-white transition-colors">
                DX Policy <span className="text-white/25 text-[10px] font-normal tracking-wide">(JP)</span>
              </Link>
            </nav>
          </div>

          <div className="border-t border-white/10 mt-12 pt-8">
            <p className="text-white/25 text-[11px] text-center leading-relaxed mb-3">
              Note: Some detail pages are currently available in Japanese only.
            </p>
